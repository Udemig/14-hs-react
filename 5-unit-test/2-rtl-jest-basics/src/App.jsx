      ...
      <main className="app-content">
        ...
        <section className="demo-section">
          ...
          <p className="description">
            Bu proje, React component'lerinde unit test yazmayı öğrenmek için hazırlanmış bir örnektir.
            <code>src/__tests__/Button.test.jsx</code> dosyasını inceleyerek test örneklerini görebilirsiniz.
          </p>

          <div className="button-group">
            <Button label="Primary Button" variant="primary" onClick={handlePrimaryClick} />
            <Button label="Secondary Button" variant="secondary" onClick={handleSecondaryClick} />
            <Button label="Danger Button" variant="danger" onClick={handleDangerClick} />
